...
FBConnect.prototype.getFriends = function () {
    var url = "https://graph.facebook.com/me/friends?fields=installed&access_token=" + this.session.access_token;
    var req = new XMLHttpRequest();
    req.open("get", url, true);
    req.send(null);
    req.onerror = function () { console.log("Error retrieving friends"); };
    return req;
}

FBConnect.prototype.getMe = function () {
    var url = "https://graph.facebook.com/me?fields=id,first_name,last_name,birthday,gender,email,picture&type=large&access_token=" + this.session.access_token;
    var req = new XMLHttpRequest();
    req.open("get", url, true);
    req.send(null);
...
FBConnect.prototype.postMessage = function (message, picture, link, name, caption, description) {
    var url = "https://graph.facebook.com/me/feed?access_token=" + this.session.access_token;
	var params = "message="+message+"&picture="+picture+"&link="+link+"&name="+name+"&caption="+caption+"&description="+description;
    var req = new XMLHttpRequest();
